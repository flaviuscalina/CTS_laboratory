...
import ro.ase.csie.cts.g1092.week2.exception.IllegalTransferException;
...
public class CurrentAccount extends BankAccount {
	...
	@Override
	public void transfer(Account destination, double ammount) throws InsufficientFundsException {
		//if(this==destination)
